...
#define es8316_RATES SNDRV_PCM_RATE_8000_48000
...
static int es8316_init_regs(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, ES8316_CLKMGR_ADCOSR_REG03, 0x32);
...
/*
	gpio_request(407,"SPK_OUT_SHUTDOWN");
...
/*
	...
	data = ioread32(gpio_mmio_base_n66);
	printk(KERN_INFO "ON66---read---data:%d---%x\n", data, data);
	data ^= (0x1<<1);
