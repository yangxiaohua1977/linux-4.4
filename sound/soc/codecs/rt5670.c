...
static struct rt5670_priv *rt5670_priv_tmp = NULL;
...
static const struct snd_kcontrol_new rt5670_snd_controls[] = {
	...
	SOC_DOUBLE_TLV("HP Playback Volume", RT5670_HP_VOL,
		...
		39, 1, out_vol_tlv),  //modifiy on 0607
	/* OUTPUT Control */
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		regmap_write(rt5670->regmap, 0x02, 0x0808); //modify on 0607
		msleep(80);
		regmap_write(rt5670->regmap, RT5670_DEPOP_M1, 0x8019);
		msleep(80);
		regmap_write(rt5670->regmap, 0x73, 0x1770);
		regmap_write(rt5670->regmap, 0x83, 0x0c00);
		regmap_write(rt5670->regmap, 0x8a, 0x1000);
		break;
...
{
	struct snd_soc_codec *codec = rt5670_priv_tmp->codec;
	unsigned int val;
	int cnt = 0, i;
		    ...
		    const struct i2c_device_id *id)
{
	...
	/*for IN1N capture*/
	regmap_update_bits(rt5670->regmap, RT5670_CJ_CTRL1, 0X40, 0X40);
	regmap_write(rt5670->regmap, RT5670_CJ_CTRL2, 0x68a7);
	regmap_write(rt5670->regmap, RT5670_GEN_CTRL2, 0x0000);
	regmap_write(rt5670->regmap, RT5670_GEN_CTRL3, 0x0104);
